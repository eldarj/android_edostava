...
public class Storage {
    ...
    public static List<HranaItemVM> getHrana() {
        if (hrana == null) {
            hrana = new ArrayList<>();
            hrana.add(new HranaItemVM("Hamburger", "Sočan hambuerger.", null, null, getRestorani().get(0), "https://www.volim-meso.hr/wordpress/wp-content/uploads/2014/06/10-hamburger-zapovjedi.jpg", 2.50));
